      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            ...
            <span className="text-gradient">portfolio better?</span>
          </h2>

          {/* Description */}
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Join thousands of investors who use Vizvest to gain deeper insights into their Trading 212 portfolios. No signup required.
          </p>
